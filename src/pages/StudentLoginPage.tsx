...
import type { LoginStudentInput } from '../services/student'

const initialForm: LoginStudentInput = {
  rollNo: '',
  password: '',
}
...
export default function StudentLoginPage() {
  ...
  const [form, setForm] = useState<LoginStudentInput>(initialForm)
  ...
  const handleChange =
    (field: keyof LoginStudentInput) => (e: ChangeEvent<HTMLInputElement>) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!form.rollNo.trim() || !form.password.trim()) {

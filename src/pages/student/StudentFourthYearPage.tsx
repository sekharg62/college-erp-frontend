...
export default function StudentFourthYearPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="mb-6 flex items-start gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl">4th Year</h1>
          <p className={`mt-1 text-sm ${mutedClass}`}>
            Content for 4th Year will appear here.
          </p>
        </div>
      </div>
      ...
      <div className={`rounded-2xl border p-6 shadow-sm ${cardClass}`}>
        <p className={`text-sm ${mutedClass}`}>
          Select materials and resources for 4th Year from this section.
        </p>
      </div>
    </div>
  )

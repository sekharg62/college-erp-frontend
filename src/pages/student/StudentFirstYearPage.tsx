...
export default function StudentFirstYearPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="mb-6 flex items-start gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl">1st Year</h1>
          <p className={`mt-1 text-sm ${mutedClass}`}>
            Content for 1st Year will appear here.
          </p>
        </div>
      </div>
      ...
      <div className={`rounded-2xl border p-6 shadow-sm ${cardClass}`}>
        <p className={`text-sm ${mutedClass}`}>
          Select materials and resources for 1st Year from this section.
        </p>
      </div>
    </div>
  )

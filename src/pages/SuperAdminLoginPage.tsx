...
import type { LoginUserInput } from '../services/User.service'
...
function SuperAdminLoginPage() {
  ...
  const handleChange =
    (field: keyof LoginUserInput) => (e: ChangeEvent<HTMLInputElement>) => {
    ...
    >
      ...
      >
        ...
        <p className={`mt-6 text-center text-sm ${subtitleClass}`}>
          <Link to="/" className={`font-medium hover:underline ${linkClass}`}>
            Back to home
          </Link>
        </p>
      </div>
